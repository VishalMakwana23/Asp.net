...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
    <br />
     <h2 align="center" style="font-family: system-ui;">EmployeePage</h2>
    <br />
     ...
     <div style="margin: 1rem;padding: 2rem 2rem;">
        ...
        <tr>
          ...
          <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList_desg" runat="server" DataSourceID="SqlDataSource1" DataTextField="desg_name" DataValueField="desg_name" Height="16px" Width="185px">
                </asp:DropDownList>
          ...
          <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList_dept" runat="server" DataSourceID="SqlDataSource2" DataTextField="dept_name" DataValueField="dept_name" Height="16px" Width="185px">
                </asp:DropDownList>
