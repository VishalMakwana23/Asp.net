...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    <div style="margin: 1rem;padding: 2rem 2rem;text-align: center;">
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList_desg" runat="server" DataSourceID="SqlDataSource1" DataTextField="desg_name" DataValueField="desg_name" Height="19px" Width="167px">
                </asp:DropDownList>
