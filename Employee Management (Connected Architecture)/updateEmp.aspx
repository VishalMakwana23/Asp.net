...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    <div style="margin: 1rem;padding: 2rem 2rem;text-align: center;">
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="desg_name" DataValueField="desg_name" Height="16px" Width="168px">
                </asp:DropDownList>
         ...
         <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" DataTextField="dept_name" DataValueField="dept_name" Height="16px" Width="168px">
                </asp:DropDownList>
