    ...
    <br />
     ...
     <div style="margin: 1rem;padding: 2rem 2rem;text-align: center;">
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList_course_d" runat="server" Height="26px" Width="168px" DataSourceID="LinqDataSource1" DataTextField="course_id" DataValueField="course_id">
                </asp:DropDownList>
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="studDataClassesDataContext" EntityTypeName="" Select="new (course_id)" TableName="courses">
                </asp:LinqDataSource>
            </td>
            <td>
                &nbsp;</td>
        ...
        <tr>
            <td>&nbsp;</td>
            <td class="auto-style1">
                <asp:Button ID="btn_insert_course" runat="server" Text="Insert" Width="85px" OnClick="btn_insert_class_Click" />
            &nbsp;
