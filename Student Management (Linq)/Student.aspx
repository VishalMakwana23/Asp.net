     ...
     <div style="margin: 1rem;padding: 2rem 2rem;">
        ...
        <tr>
          ...
          <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="Class_drop" runat="server" DataSourceID="LinqDataSource1" DataTextField="class_name" DataValueField="class_name" Height="25px" Width="187px">
                </asp:DropDownList>
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="studDataClassesDataContext" EntityTypeName="" Select="new (class_name)" TableName="classes">
                </asp:LinqDataSource>
            </td>
            <td>
                &nbsp;</td>
          ...
          <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="Course_drop" runat="server" DataSourceID="LinqDataSource2" DataTextField="course_name" DataValueField="course_name" Height="25px" Width="187px">
                </asp:DropDownList>
                <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="studDataClassesDataContext" EntityTypeName="" Select="new (course_name)" TableName="courses">
                </asp:LinqDataSource>
            </td>
            <td>
                &nbsp;</td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                <br />
                <asp:Button ID="btn_insert_course" runat="server" Text="Insert" OnClick="btn_insert_course_Click" Width="85px" /> 
                &nbsp;&nbsp;&nbsp;&nbsp; 
