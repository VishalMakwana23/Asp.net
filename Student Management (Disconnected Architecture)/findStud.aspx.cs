...
public partial class findStud : System.Web.UI.Page
{
    ...
    protected void btn_find_stud_Click(object sender, EventArgs e)
    {
        try
        {
            cn.Open();
            SqlDataAdapter da = new SqlDataAdapter("select * from Student where name='"+txt_name.Text+"' AND course='"+drop_course.SelectedValue+"'", cn);
