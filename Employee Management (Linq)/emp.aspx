     ...
     <div style="margin: 1rem;padding: 2rem 2rem;">
        ...
        <tr>
          ...
          <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="LinqDataSource1" DataTextField="desg_name" DataValueField="desg_name" Height="22px" Width="181px">
                </asp:DropDownList>
          ...
          <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="LinqDataSource2" DataTextField="dept_name" DataValueField="dept_name" Height="20px" Width="184px">
                </asp:DropDownList>
          ...
          <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="txt_salary" runat="server" Width="180px"></asp:TextBox>
            </td>
            <td>
