...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
     <br />
     <h2 align="center" style="font-family: system-ui;">Display Employee Page</h2>
    <br />
     ...
     <div style="margin: 1rem;padding: 2rem 2rem;text-align: center;">
        <div style="display: inline-block;padding: 1rem 1rem;vertical-align: middle;">
            ...
            <Columns>
               ...
               <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ASS3_Q6ConnectionString %>" SelectCommand="SELECT * FROM [Emp]"></asp:SqlDataSource>
        </div>
    </div>
</asp:Content>
