<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.master" AutoEventWireup="true" CodeFile="department.aspx.cs" Inherits="department" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
     <br />
     <h2 align="center" style="font-family: system-ui;">Department Page</h2>
    <br />
     ...
     <div style="margin: 1rem;padding: 2rem 2rem;text-align: center;">
        ...
        <tr>
            <td>&nbsp;</td>
            <td class="auto-style1">
                <asp:Button ID="btn_insert_dept" runat="server" Text="Insert" Width="69px" OnClick="btn_insert_dept_Click" />
                <asp:Button ID="btn_delete" runat="server" Text="Delete" Width="69px" CausesValidation="False" OnClick="btn_delete_Click" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
