     ...
     <div style="margin: 1rem;padding: 2rem 2rem;">
        ...
        <tr>
          ...
          <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="Class_drop" runat="server" DataSourceID="SqlDataSource1" DataTextField="clas_name" DataValueField="clas_name" Height="16px" Width="181px">
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mycn %>" SelectCommand="SELECT [clas_name] FROM [Class]"></asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
        </tr>
          <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="Course_drop" runat="server" DataSourceID="SqlDataSource2" DataTextField="course_name" DataValueField="course_name" Height="16px" Width="181px">
                </asp:DropDownList>
