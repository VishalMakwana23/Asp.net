    ...
    <br />
     ...
     <div style="margin: 1rem;padding: 2rem 2rem;text-align: center;">
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="course_id" DataValueField="course_id" Height="32px" Width="168px">
                </asp:DropDownList>
        ...
        <tr>
            <td>&nbsp;</td>
            <td class="auto-style1">
                <asp:Button ID="btn_insert_course" runat="server" Text="Insert" Width="85px" OnClick="btn_insert_course_Click" />
            &nbsp;
