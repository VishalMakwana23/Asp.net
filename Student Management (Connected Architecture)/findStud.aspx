    ...
    <br />
     ...
     <div style="margin: 1rem;padding: 2rem 2rem;text-align: center;">
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:DropDownList ID="Course_drop" runat="server" DataSourceID="SqlDataSource1" DataTextField="course_name" DataValueField="course_name" Height="16px" Width="166px">
                </asp:DropDownList>
        ...
        <tr>
            <td>&nbsp;</td>
            <td class="auto-style1">
                <asp:Button ID="btn_find_stud" runat="server" Text="Find" Width="168px" OnClick="btn_insert_course_Click" CausesValidation="False" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
